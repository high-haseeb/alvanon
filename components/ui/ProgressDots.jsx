...
const Dot = ({section, active}) => {
  ...
  return(
      <div className={ `rounded-full ${active === section ?  'bg-white' : 'bg-white/40' } border border-gray-500/40 w-2 h-2 cursor-pointer` } title={section} onClick={() => scrollToSection(section)}/>
  )
}
